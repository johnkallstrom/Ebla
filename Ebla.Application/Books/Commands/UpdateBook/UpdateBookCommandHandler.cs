...
{
    public class UpdateBookCommandHandler : IRequestHandler<UpdateBookCommand, IResult<int>>
    {
        ...
        public async Task<IResult<int>> Handle(UpdateBookCommand request, CancellationToken cancellationToken)
        {
