namespace Ebla.Application.UseCases.Reservation.Commands
{
    public class CreateReservationCommandHandler : IRequestHandler<CreateReservationCommand, Response<int>>
    {
        ...
        private readonly IGenericRepository<Domain.Entities.Reservation> _repository;
        ...
        public CreateReservationCommandHandler(
            IMapper mapper,
            IGenericRepository<Domain.Entities.Reservation> repository,
        ...
        public async Task<Response<int>> Handle(CreateReservationCommand request, CancellationToken cancellationToken)
        {
            ...
            if (validationResult.IsValid)
            {
                ...
                var reservationToAdd = _mapper.Map<Domain.Entities.Reservation>(request);
